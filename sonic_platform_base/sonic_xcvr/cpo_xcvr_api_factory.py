...
class CpoXcvrApiFactory():
    ...
    def get_elsfp_vendor_info(self, hardware_id: CpoHardwareId):
        # TODO: Implement logic to read the EEPROM directly of the ELSFP to find the vendor
        # name and part number of the ELSFP currently plugged into the switch.
        # hardware_id.oe_id can be used to understand where page 0 of the ELSFP resides
        # in the address space of the EEPROM.
        return None
