"""
    ...
    Broadcom TH6 ELSFP memory map.
"""

from ..public.cmis import CmisFlatMemMap
from ..public.cmis_pages import (
...
class BroadcomTh6ElsfpMemMap(CmisFlatMemMap):
    def __init__(self, codes, bank=0):
        # Bypass CmisFlatMemMap.__init__ so we don't register the default
        # CMIS pages — TH6 ELSFP relocates the CMIS pages onto a contiguous
        # 0xB0..0xB5 range.
        self._bank = bank
