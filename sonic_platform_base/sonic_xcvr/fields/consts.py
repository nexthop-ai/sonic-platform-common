...
<<<<<<< HEAD
=======
RX_AVG_CLOCK_REC_PM = "rxAvgClockRecPm"
RX_MIN_CLOCK_REC_PM = "rxMinClockRecPm"
RX_MAX_CLOCK_REC_PM = "rxMaxClockRecPm"
RX_AVG_LG_SOPMD_PM = "rxAvgLGSopmdPm"
RX_MIN_LG_SOPMD_PM = "rxMinLGSopmdPm"
RX_MAX_LG_SOPMD_PM = "rxMaxLGSopmdPm"
RX_AVG_SNR_MARGIN_PM = "rxAvgSNRMarginPm"
RX_MIN_SNR_MARGIN_PM = "rxMinSNRMarginPm"
...
RX_AVG_QMARGIN_PM = "rxAvgQMarginPm"
RX_MIN_QMARGIN_PM = "rxMinQMarginPm"
RX_MAX_QMARGIN_PM = "rxMaxQMarginPm"

## Data Path Host Interface Performance Monitoring
DATA_PATH_HOST_IF_PM = "Data Path Host Interface Performance Monitoring"
TX_BITS_PM = "txBitsPm"
TX_BITS_SUB_INTERVAL_PM = "txBitsSubIntPm"
TX_CORR_BITS_PM = "txCorrBitsPm"
TX_MIN_CORR_BITS_SUB_INTERVAL_PM = "txMinCorrBitsSubIntPm"
TX_MAX_CORR_BITS_SUB_INTERVAL_PM = "txMaxCorrBitsSubIntPm"
TX_FRAMES_PM = "txFramesPm"
TX_FRAMES_SUB_INTERVAL_PM = "txFramesSubIntPm"
TX_FRAMES_UNCORR_ERR_PM = "txFramesUncorrErrPm"
TX_MIN_FRAMES_UNCORR_ERR_SUB_INTERVAL_PM = "txMinFramesUncorrErrSubintPm"
TX_MAX_FRAMES_UNCORR_ERR_SUB_INTERVAL_PM = "txMaxFramesUncorrErrSubintPm"
TX_CORRECTED_FRAMES_PM = "txCorrectedFramesPm"
TX_CORRECTED_FRAMES_SUB_INTERVAL_PM = "txCorrectedFramesSubintPm"

## Media Lane Configurable Thresholds (Page 30h)
MEDIA_LANE_CONFIG_THRESHOLDS = "Media Lane Configurable Thresholds"
TOTAL_PWR_HIGH_ALARM_THRESH = "totalPwrHiAlarmThresh"
TOTAL_PWR_LOW_ALARM_THRESH = "totalPwrLoAlarmThresh"
TOTAL_PWR_HIGH_WARN_THRESH = "totalPwrHiWarnThresh"
TOTAL_PWR_LOW_WARN_THRESH = "totalPwrLoWarnThresh"
SIG_PWR_HIGH_ALARM_THRESH = "sigPwrHiAlarmThresh"
SIG_PWR_LOW_ALARM_THRESH = "sigPwrLoAlarmThresh"
SIG_PWR_HIGH_WARN_THRESH = "sigPwrHiWarnThresh"
SIG_PWR_LOW_WARN_THRESH = "sigPwrLoWarnThresh"
TOTAL_PWR_USE_CFG_THRESH = "totalPwrUseCfgThresh"
SIG_PWR_USE_CFG_THRESH = "sigPwrUseCfgThresh"
FDD_RAISE_THRESH = "fddRaiseThresh"
FDD_CLEAR_THRESH = "fddClearThresh"
FED_RAISE_THRESH = "fedRaiseThresh"
FED_CLEAR_THRESH = "fedClearThresh"
FED_ENABLE = "fedEnable"
FDD_ENABLE = "fddEnable"
MEDIA_FDD_FED_ENABLE = "mediaFddFedEnable"

## Media Lane Flags and Status (Page 33h)
MEDIA_LANE_FLAGS_STATUS = "Media Lane Flags and Status"
MEDIA_FDD_FED_FLAGS = "mediaFddFedFlags"
L_TX_LOA = "lTxLoa"
L_TX_OOA = "lTxOoa"
L_TX_LOL_CMU = "lTxLolCmu"
L_TX_LOL_REF_CLK = "lTxLolRefClk"
L_TX_LOL_DESKEW = "lTxLolDeSkew"
L_TX_FIFO = "lTxFIFO"
L_RX_LOF = "lRxLof"
L_RX_LOM = "lRxLom"
L_RX_LOL_DEMOD = "lRxLolDemod"
L_RX_LOL_CD = "lRxLolCd"
L_RX_LOA = "lRxLoa"
L_RX_OOA = "lRxOoa"
L_RX_LOL_DESKEW = "lRxLolDeskew"
L_RX_LOL_FIFO = "lRxLolFifo"
L_RX_FED_PM = "lRxFedPm"
L_RX_FDD_PM = "lRxFddPm"
L_RX_STAT_MNT_AIS = "lrxStatMNTAIS"
L_RX_STAT_MNT_LCK = "lrxStatMNTLCK"
L_RX_PYLD_TYP_MM = "lRxPyldTypMM"
L_RD = "lRD"
L_LD = "lLD"
L_STAT_RF = "lSTATRF"
RX_PYLD_TYPE = "rxPyldType"

## Data Path Host Interface Configuration (Page 38h)
DATA_PATH_HOST_IF_CONFIG = "Data Path Host Interface Configuration"
HOST_FDD_FED_CONS_ACT_ENABLE = "hostFddFedConsActEnable"
FDD_ACT_BER_THRESH = "fddActBerThresh"
FDD_CLR_BER_THRESH = "fddClrBerThresh"
FED_ACT_BER_THRESH = "fedActBerThresh"
FED_CLR_BER_THRESH = "fedClrBerThresh"
TX_FED_CONS_ACT_ENABLE = "txfedConsActEnable"
RX_FED_CONS_ACT_ENABLE = "rxfedConsActEnable"
RX_LF_INSERTION_ON_CSF_ENABLE = "rxlfInsertionOnCsfEnable"
TX_LF_INSERTION_ON_LD_ENABLE = "txlfInsertionOnLdEnable"
FED_MON_ENABLE = "fedMonEnable"
FDD_MON_ENABLE = "fddMonEnable"
RX_CONS_ACT = "rxConsAct"
TX_CONS_ACT = "txConsAct"
RX_CONS_ACT_HOLD_OFF_TMR = "rxConsActHoldOffTmr"
TX_CONS_ACT_HOLD_OFF_TMR = "txConsActHoldOffTmr"
RX_RPLC_SIG_INSERTION = "rxRplcSigInsertion"
TX_RPLC_SIG_INSERTION = "txRplcSigInsertion"
TX_CSTAT_LCK_INSERTION = "txCStatLCKInsertion"

## Data Path Host Interface Flags, Masks and Status (Page 3Bh)
DATA_PATH_HOST_IF_FLAGS = "Data Path Host Interface Flags Masks and Status"
HOST_FDD_FED_FLAGS = "hostFddFedFlags"
M_TX_FED_PM = "mtxFedPm"
M_TX_FDD_PM = "mtxFddPm"
M_RX_RD = "mrxRD"
M_TR_LD = "mtrLD"
M_RX_CSTAT_MNT_LCK = "mrxCStatMNTLCK"
M_RX_MSIM = "mRxMSIM"
M_RX_CSTAT_CSF = "mRxCStatCSF"
M_TX_RD = "mtxRD"
M_TX_LD = "mtxLD"
M_RX_FLEXE_RPF = "mrxFlexeRPF"
M_RX_FLEXE_GID_MM = "mrxFlexegidMM"
M_RX_FLEXE_INSTANCE_MAP_MM = "mrxFlexeInstanceMapMM"
M_RX_FLEXE_CALENDAR_MM = "mrxFlexeCalendarMM"
M_RX_FLEXE_IID_MM = "mrxFlexeiidMM"
M_RX_FLEXE_LOF = "mrxFlexeLOF"
M_RX_FLEXE_LOM = "mrxFlexeLOM"
M_RX_FLEXE_LOPB = "mrxFlexeLOPB"
M_TX_LOA = "mtxLOA"
M_TX_RF = "mtxRF"
M_TX_LF = "mtxLF"
M_RX_LOA = "mrxLOA"
M_RX_RF = "mrxRF"
M_RX_LF = "mrxLF"
L_TX_FED_PM = "ltxFedPm"
L_TX_FDD_PM = "ltxFddPm"
L_RX_RD = "lrxRD"
L_RX_LD = "lrxLD"
L_RX_CSTAT_MNT_LCK = "lrxCStatMNTLCK"
L_RX_MSIM = "lRxMSIM"
L_RX_CSTAT_CSF = "lRxCStatCSF"
L_TX_RD = "ltxRD"
L_TX_LD = "ltxLD"
L_RX_FLEXE_RPF = "lrxFlexeRPF"
L_RX_FLEXE_GID_MM = "lrxFlexegidMM"
L_RX_FLEXE_INSTANCE_MAP_MM = "lrxFlexeInstanceMapMM"
L_RX_FLEXE_CALENDAR_MM = "lrxFlexeCalendarMM"
L_RX_FLEXE_IID_MM = "lrxFlexeiidMM"
L_RX_FLEXE_LOF = "lrxFlexeLOF"
L_RX_FLEXE_LOM = "lrxFlexeLOM"
L_RX_FLEXE_LOPB = "lrxFlexeLOPB"
L_TX_LOA_HOST = "ltxLOA"
L_TX_RF = "ltxRF"
L_TX_LF = "ltxLF"
L_RX_LOA_HOST = "lrxLOA"
L_RX_RF = "lrxRF"
L_RX_LF = "lrxLF"

## Alarm Advertisement (Page 44h)
ALARM_ADVERTISEMENT = "Alarm Advertisement"
MEDIA_TX_LOA_IMPL = "MediaTxLoaImpl"
MEDIA_TX_OOA_IMPL = "MediaTxOoaImpl"
MEDIA_TX_LOL_CMU_IMPL = "MediaTxLolCmuImpl"
MEDIA_TX_LOL_REF_CLK_IMPL = "MediaTxLolRefClkImpl"
MEDIA_TX_LOL_DESKEW_IMPL = "MediaTxLolDeSkewImpl"
MEDIA_TX_FIFO_IMPL = "MediaTxFIFOImpl"
MEDIA_RX_LOF_IMPL = "MediaRxLofImpl"
MEDIA_RX_LOM_IMPL = "MediaRxLomImpl"
MEDIA_RX_LOL_DEMOD_IMPL = "MediaRxLolDemodImpl"
MEDIA_RX_LOL_CD_IMPL = "MediaRxLolCdImpl"
MEDIA_RX_LOA_IMPL = "MediaRxLoaImpl"
MEDIA_RX_OOA_IMPL = "MediaRxOoaImpl"
MEDIA_RX_LOL_DESKEW_IMPL = "MediaRxLolDeskewImpl"
MEDIA_RX_LOL_FIFO_IMPL = "MediaRxLolFifoImpl"
MEDIA_RX_FED_ALM_IMPL = "MediaRxFedAlmImpl"
MEDIA_RX_FDD_ALM_IMPL = "MediaRxFddAlmImpl"
RX_STAT_MNT_AIS_IMPL = "rxStatMNTAISImpl"
RX_STAT_MNT_LCK_IMPL = "rxStatMNTLCKImpl"
MEDIA_RX_PYLD_TYP_MM_IMPL = "MediaRxPyldTypMMImpl"
MEDIA_RD_IMPL = "MediaRDImpl"
MEDIA_LD_IMPL = "MediaLDImpl"
MEDIA_STAT_RF_IMPL = "MediaSTATRFImpl"
HOST_TX_FED_ALM_IMPL = "HostTxFedAlmImpl"
HOST_TX_FDD_ALM_IMPL = "HostTxFddAlmImpl"
HOST_RX_RD_IMPL = "HostRxRDImpl"
HOST_RX_LD_IMPL = "HostRxLDImpl"
HOST_RX_CSTAT_MNT_LCK_IMPL = "HostRxCStatMNTLCKImpl"
HOST_TX_RD_IMPL = "HostTxRDImpl"
HOST_TX_LD_IMPL = "HostTxLDImpl"
HOST_RX_FLEXE_RPF_IMPL = "HostRxFlexeRPFImpl"
HOST_RX_FLEXE_GID_MM_IMPL = "HostRxFlexegidMMImpl"
HOST_RX_FLEXE_INSTANCE_MAP_MM_IMPL = "HostRxFlexeInstanceMapMMImpl"
HOST_RX_FLEXE_CALENDAR_MM_IMPL = "HostRxFlexeCalendarMMImpl"
HOST_RX_FLEXE_IID_MM_IMPL = "HostRxFlexeiidMMImpl"
HOST_RX_FLEXE_LOF_IMPL = "HostRxFlexeLOFImpl"
HOST_RX_FLEXE_LOM_IMPL = "HostRxFlexeLOMImpl"
HOST_RX_FLEXE_LOPB_IMPL = "HostRxFlexeLOPBImpl"
HOST_TX_LOA_IMPL = "HostTxLOAImpl"
HOST_TX_RF_IMPL = "HostTxRFImpl"
HOST_TX_LF_IMPL = "HostTxLFImpl"
HOST_RX_LOA_IMPL = "HostRxLOAImpl"
HOST_RX_RF_IMPL = "HostRxRFImpl"
HOST_RX_LF_IMPL = "HostRxLFImpl"
RX_MSIM_IMPL = "RxMSIMImpl"
RX_CSTAT_CSF_IMPL = "RxCStatCSFImpl"
RX_PAYLOAD_TYPE_IMPL = "rxPayloadTypeImpl"

## Host Lane Provisioning Advertisement (Page 45h)
HOST_LANE_PROVISIONING_ADVERTISEMENT = "Host Lane Provisioning Advertisement"
TX_FED_CONS_ACT_ENABLE_IMPL = "txfedConsActEnableImpl"
RX_FED_CONS_ACT_ENABLE_IMPL = "rxfedConsActEnableImpl"
RX_LF_INSERTION_ON_CSF_ENABLE_IMPL = "rxlfInsertionOnCsfEnableImpl"
TX_LF_INSERTION_ON_LD_ENABLE_IMPL = "txlfInsertionOnLdEnableImpl"
FED_MON_ENABLE_IMPL = "fedMonEnableImpl"
FDD_MON_ENABLE_IMPL = "fddMonEnableImpl"
TX_CSTAT_LCK_INSERTION_IMPL = "txCStatLCKInsertionImpl"
RX_RPLC_SIG_INSERTION_IMPL = "rxRplcSigInsertionImpl"
TX_RPLC_SIG_INSERTION_IMPL = "txRplcSigInsertionImpl"
TX_CONS_ACT_HOLD_OFF_TMR_IMPL = "txConsActHoldOffTmrImpl"
RX_CONS_ACT_HOLD_OFF_TMR_IMPL = "rxConsActHoldOffTmrImpl"
RX_CONS_ACT_IMPL = "rxConsActImpl"
TX_CONS_ACT_IMPL = "txConsActImpl"
